...
The match consists of _N_ Rounds. Each round follows this strict state machine:
...
- **Suggestions Service (Express.js):**
  - **Responsibility:** Searchs for track results based on input term to be used in a suggestion dropdown in frontend search bar.
- **Playlist Service (Express.js):**
  - **Responsibility:** Orchestrates playlist generation.
