...
export const SpotifyProfileScalarFieldEnumSchema = z.enum(['id','userId','spotifyUserId','displayName','email','avatarUrl','topArtists','topGenres','topTrackMonth','topTrackAllTime','syncedAt','createdAt','updatedAt']);
